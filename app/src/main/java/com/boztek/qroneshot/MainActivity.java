...
public class MainActivity extends Activity {
    ...
    void buildUi() {
        ...
        root.addView(text(
                "QR bir kez okunur ve kamera otomatik kapanır",
                16,
        ...
        Button scanButton = button("QR OKUT", BLUE);
    ...
    protected void onActivityResult(
        ...
        // Kamera kapandıktan sonra servera yalnızca bir kayıt gönder.
